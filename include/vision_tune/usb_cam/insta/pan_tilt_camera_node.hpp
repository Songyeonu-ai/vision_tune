...
#include <vision_tune/msg/pan_tilt_msgs.hpp>
...
private:
  ...
  rclcpp_lifecycle::LifecyclePublisher<vision_tune::msg::PanTiltStatusMsgs>::SharedPtr pan_tilt_status_pub_;
  ...
  rclcpp::Subscription<vision_tune::msg::PanTiltMsgs>::SharedPtr pan_tilt_sub_;

  rclcpp::TimerBase::SharedPtr timer_;
  OnSetParametersCallbackHandle::SharedPtr param_change_callback_;
  void pan_tilt_callback(const vision_tune::msg::PanTiltMsgs::SharedPtr msg);
